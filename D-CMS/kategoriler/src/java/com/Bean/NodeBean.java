...
//	makaleler=em.createQuery("select i from com.kategori.Kategoriler i").getResultList();
...
//          
    ...
    private  List<Kategoriler> makaleler;
    
     public List<Kategoriler> getMakaleler() {
        return makaleler;
    }

    public void setMakaleler(List<Kategoriler> makaleler) {
...
//        FacesContext.getCurrentInstance().addMessage(null, message);  
    ...
    public String duzenle() throws NoSuchAlgorithmException { //veritabanımıza Düzenle işlemlerinin gerçekleştirildiği fonksiyon     
